...
export const ADD_ON_CATALOG = [
  { key: "digitalSelling", group: "البيع الرقمي", groupEn: "Digital selling", title: "البيع الرقمي", titleEn: "Digital selling", price: 0, desc: "عميلك يدفع ببطاقته أو محفظته ويستلم ملفه فورًا خلال ثوانٍ، بدون ما تراجع أو تؤكد شي بنفسك. اربط بوابة الدفع الخاصة بك من الإعدادات (بوابة الدفع الخاصة بك) أولًا، ثم فعّل هذه الإضافة مجانًا.", descEn: "Your customer pays by card or wallet and receives their file instantly within seconds, with no manual review or confirmation from you. Connect your own payment gateway from Settings first, then enable this add-on for free.", status: "متاح الآن", ready: true },
