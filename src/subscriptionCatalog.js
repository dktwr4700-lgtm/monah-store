...
export const ADD_ON_CATALOG = [
  { key: "digitalSelling", group: "البيع الرقمي", title: "البيع الرقمي", price: 2, desc: "عميلك يدفع ببطاقته أو محفظته ويستلم ملفه فورًا خلال ثوانٍ، بدون ما تراجع أو تؤكد شي بنفسك. يحتاج بعد التفعيل خطوة إضافية: تربط بوابة الدفع الخاصة بك من الإعدادات (بوابة الدفع الخاصة بك) حتى تشتغل الميزة فعليًا.", status: "متاح الآن", ready: true },
