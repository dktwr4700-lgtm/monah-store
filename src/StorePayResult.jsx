...
const SPR_T = {
  ar: {
    ...
    signupActivatedTitle: "تم تفعيل متجرك 🎉", signupActivatedCopy: "اشتراكك فعّال الآن لمدة 30 يوم. تقدر تنشر منتجاتك وتبدأ تبيع من لوحة التاجر.",
  ...
  en: {
    ...
    signupActivatedTitle: "Your store is activated 🎉", signupActivatedCopy: "Your subscription is active now for 30 days. You can publish your products and start selling from the seller dashboard.",
