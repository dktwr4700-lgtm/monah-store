...
const TERMS = {
  ...
  sections: [
    ...
    },
    {
      ...
      p: [
        "يبدأ الاشتراك المرن بمتجر أساسي بسعر 3 ر.ع ثم إضافات يختارها التاجر. يظهر السعر الإجمالي وطريقة التفعيل بوضوح قبل أي تحصيل.",
        "لا يتجدد الاشتراك أو تتفعل إضافة مدفوعة إلا بعد أن يطّلع التاجر على السعر والشروط المعروضة ويؤكد عملية التفعيل بالطريقة المتاحة داخل المنصة.",
      ],
    },
    {
      h: "الحزم والميزات المقفلة",
      p: ["يمكن للتاجر تجهيز حزم منتجات وحفظها أو إخفاؤها أو حذفها من لوحة التحكم. لا تظهر الحزمة للزوار ولا تتاح للشراء إلا إذا ظهرت لها حالة إتاحة واضحة داخل المنصة."],
    },
    {
      h: "مسؤولية البائع",
      list: [
    ...
    <div className="lg-page" dir="rtl" lang="ar">
      ...
      <div className="lg-wrap">
        ...
        <div className="lg-note">
          هذه مسودة تشغيلية تشرح طريقة استخدام المنصة وليست استشارة قانونية. نوصي بمراجعتها مع مختص قانوني قبل اعتمادها النهائي.
        </div>
      </div>
    </div>
  );
