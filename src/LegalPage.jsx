  ...
  sections: [
    {
      ...
      p: ["نجمع بريدك الإلكتروني عند الشراء، وبيانات حسابك (اسم المتجر، شعار، بيانات تواصل) لو سجّلت كبائع."],
    },
    {
...
const TERMS = {
  ...
  sections: [
    {
      h: "طبيعة الخدمة",
      p: ["Monah منصة تتيح للبائعين إنشاء متجر رقمي وبيع منتجاتهم الرقمية (ملفات، أكواد تفعيل) مقابل اشتراك شهري، بدون عمولة على المبيعات."],
    },
    {
      h: "مسؤولية البائع",
      list: [
    ...
    },
    {
      h: "الدفع والاسترجاع",
      p: [
        "الاشتراك الشهري يُجدد تلقائيًا ما لم يُلغَ من لوحة التحكم.",
