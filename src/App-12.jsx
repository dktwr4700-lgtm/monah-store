      ...
      <header>
        <div className="wrap nav">
          ...
          <div className="nav-cta">
            <a href="#login" className="btn btn-outline" style={{ padding: "9px 15px" }}>تسجيل الدخول</a>
            <a href="#register" className="btn btn-primary" style={{ padding: "9px 15px" }}>ابدأ البيع</a>
          </div>
        </div>
      </header>
        ...
        <div className="wrap hero-grid">
          <div>
            ...
            <div className="hero-actions">
              <a href="#register" className="btn btn-primary">ابدأ البيع</a>
      ...
      <section>
        <div className="wrap">
          <div className="cta-band">
            ...
            <a href="#register" className="btn btn-accent">ابدأ البيع مجانًا</a>
          </div>
        </div>
      </section>
