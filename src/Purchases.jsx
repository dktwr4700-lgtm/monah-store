...
const BUY_T = {
  ar: {
    ...
    preparing: "جاري التجهيز...", playNow: "تشغيل الآن",
    ...
    activationNote: "🔒 هذا المنتج يشتغل مباشرة من الموقع — اضغط \"تشغيل الآن\" فوق، ما تحتاج تنزّل أي ملف.",
