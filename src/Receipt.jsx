...
const styles = `
  ...
  .rcpt-label{color:#5A5648;font-size:11px;margin-top:2px}
  ...
  .rcpt-row span:first-child{color:#5A5648}
  ...
  .rcpt-note{font-size:10.5px;color:#7A766A;text-align:center;margin-top:20px;line-height:1.8}
  ...
  .rcpt-error,.rcpt-empty{background:#fff;border:1px solid #e5e0d6;border-radius:18px;padding:30px 18px;text-align:center;font-size:12px;line-height:1.9;color:#525252}
  @media print{
